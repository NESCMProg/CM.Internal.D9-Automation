...
public class EditCustomBlockTest extends base {
	...
	public void provideCustomBLockTitle(String inputCustomTitle, String editedTitle, String E_CustomLog) {
		...
		Log.info(
				"Test Description: Navigate to Custom Blocks Page in Custom Blocks Tile. Search one Custom Block in search bar. If the following Custom Block is present in Custom Blocks"
						...
						+ " Note: Custom title value is taken from Excel sheet : inputcustom");
		cbvp.searchCustomBlockTitle(inputCustomTitle, editedTitle, E_CustomLog);
