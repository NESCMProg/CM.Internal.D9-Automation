...
public class EditCalloutsTest extends base {
	...
	public void setUp() throws IOException, InterruptedException {
		...
		Log.info("Callout Edit Functionality");
	...
	/*
	 * @DataProvider public Object[][] UpdateCalloutData() {
	 * 
	 * Object data[][]=null; try { data = TestUtil.getTestData("updatecallout"); }
	...
	/*
	 * @Test(dataProvider="UpdateCalloutData", priority=2) public void
	 * updateTest(String EditTitle1, String EditSubtitle1, String EditDescription) {
	 * 
	 * String abc =
	 * driver.findElement(By.xpath("//tr[@class='odd']/td[1]")).getText();
	 * System.out.println(abc); if(abc.equals(EditTitle1))
	 * System.out.println(EditTitle1); System.out.println(EditTitle1); {
	 * driver.findElement(By.xpath(
	 * "//tr[@class='odd']/td[1]//following-sibling::td[6]/a[1]")).click();
	 * Log.info("Module Name: Callouts"); Log.info("Test Case ID: TS_CO_05");
	 * Log.info("Test Designed By: Charan"); Log.info("Test Priority: Medium");
	 * Log.info("Test Executed By: "+machineName );
	 * Log.info("Test Executed Date: "+currentDateTime); Log.
	 * info("Test Description: Navigate to Callouts Page in Callouts Tile. Select the first Callout in the table grid."
	...
	public void provideCalloutTitle(String inputExcelTitle, String editedTitle1) {
		...
		Log.info(
				"Test Description: Navigate to Callouts Page in Callouts Tile. Search one callout in search bar. If the following callout is present in Callout"
		...
		covp.searchCalloutTitle(inputExcelTitle, editedTitle1);
		Log.info("Test Result: Pass");
		System.out.println(inputExcelTitle);
		System.out.println("searchCalloutTitle ,method is implemented");
	}
