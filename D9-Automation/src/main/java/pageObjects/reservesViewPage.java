...
public class reservesViewPage extends base {
	...
	public void clickReserveNewandSaveBtn(String C_reserveTitle, String C_Languauge, String C_registrarID,
			String C_courseID, String C_startDate, String C_startTime, String C_endDate, String C_endTime, String C_ISBN)
			...
			for(int i=1; i<=fieldMSG;i++) {
				try {
					...
					String secondAlerts = driver.findElement(By.xpath("//tbody/tr[1]/td[2]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]")).getText();
	...
	public void deleteReserveListBtn(String deletereserveTitle, String D_language, String D_registrarID, String D_courseID, String D_startDate, String D_startTime, String D_endDate, String D_endTime, String D_Reserve) throws InterruptedException {
		addNewReserve.click();
